...
Client.prototype.send_message = function(message){
    ...
    var params = {'api_key' : this.api_key,'api_hash':this.api_hash};
    return post_request(end_points['send_sms'], data, params);
};
...
Client.prototype.start_verify = function(number, name){
    ...
    var params = {'api_key' : this.api_key,'api_hash':this.api_hash};
    return post_request(end_points['start_verify'], data, params);
};
Client.prototype.confirm_verify = function(number, code){ 
    let  data = {'number':number, 'code':code};
    var params = {'api_key' : this.api_key,'api_hash':this.api_hash};
    return    post_request(end_points['confirm_verify'], data, params);
};
